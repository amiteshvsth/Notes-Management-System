...
$ret=mysqli_query($con,"select tblregistration where emailId='$emailid' || mobileNumber='$mobileno'");
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">e-Diary Management System</h3></div>
